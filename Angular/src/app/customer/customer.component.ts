 ...
 ngOnInit() {
  ...
  save_func() {
    if (this.views.titleName == null) {
      ...
      this.httpClient.post('http://localhost:8080/customer/' + this.views.titleName + '/' + this.views.customerName + '/' + this.views.sex+ '/' + this.views.email+ '/' + this.views.pass+ '/' + this.views.countryCodes+ '/' + this.views.phone+ '/' + this.views.address, this.views)
      .subscribe(
          data => {
